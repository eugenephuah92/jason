    ...
    <div class="col-md-4 col-md-offset-4 col-xs-12 col-xs-offset-0 col-sm-6 col-sm-offset-3 login mt50">
        ...
        <div class="form-group clearfix">
                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-user"></i></span>
                    <asp:TextBox ID="txtUsername" CssClass="form-control tb" placeholder="Username" runat="server" />
                </div>
        </div>
        <div class="form-group clearfix">
        ...
        <div class="form-group clearfix">
            ...
            <asp:Button ID="btnSubmit" CssClass="btn btn-success pull-right" Text="Log In" runat="server" /> 
        </div>
